...
// Type-only: filesystem.ts needs FileSystemSearch.node while it loads, so a runtime import back
// into it lets bundle evaluation order leave that dependency undefined.
