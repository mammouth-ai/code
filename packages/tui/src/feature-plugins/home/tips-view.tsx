...
const TIPS: Tip[] = [
  ...
  "Run {highlight}/share{/highlight} to create a public mammouth.ai link",
  ...
  "Create {highlight}mammouth.json{/highlight} for server settings, and {highlight}tui.json{/highlight} for TUI",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.mammouth/commands/{/highlight} for reusable prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Add {highlight}.md{/highlight} files to {highlight}.mammouth/agents/{/highlight} for specialized AI personas",
  ...
  "Add {highlight}.ts{/highlight} files to {highlight}.mammouth/plugins/{/highlight} for event hooks",
